...
use ValBundle\Form\RegisterType;
...
class RegisterController extends Controller
{
     ...
     * @Method("POST")
     * @Template("ValBundle:Register:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ValBundle:Register')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ValBundle:Register:edit.html.twig")
     */
